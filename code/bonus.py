...
class Bonus:
    ...
    def __init__(self, type, x, y, screen_width, screen_height, speed=2):
        ...
        :param type: Tipo do bônus (ex.: "double", "slow").
        :param x: Posição X inicial do bônus.
        :param y: Posição Y inicial do bônus.
        :param screen_width: Largura da tela.
        :param screen_height: Altura da tela.
        :param speed: Velocidade de movimento do bônus.
        """
        ...
        self.image = pygame.transform.scale(self.image, (50, 50))  # Tamanho fixo de 50x50 para consistência
    ...
    def apply_bonus(self, obstacles, background):
        ...
        :param obstacles: Lista de obstáculos no jogo.
        :param background: Instância do fundo do jogo.
        """
        if self.type == "double":
            # Multiplica a pontuação em uma classe externa (como GameManager)
            return "double"  # Retorna um sinalizador para o GameManager (opcional)
        elif self.type == "slow":
